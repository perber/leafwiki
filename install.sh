...
case "$ARCHI" in 
    "amd64")
        wget https://github.com/perber/leafwiki/releases/download/v0.4.8/leafwiki-v0.4.8-linux-amd64
        chmod +x ./leafwiki-v0.4.8-linux-amd64
        EXEC_NAME="leafwiki-v0.4.8-linux-amd64"
        ;;
    "arm64")
        wget https://github.com/perber/leafwiki/releases/download/v0.4.8/leafwiki-v0.4.8-linux-arm64
